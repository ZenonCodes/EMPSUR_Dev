...
/**
 * REST controller for managing {@link com.empsur.empsur.domain.Employee}.
 */
@RestController
@RequestMapping("/api")
public class EmployeeResource {
    ...
    public ResponseEntity<List<Employee>> getAllEmployees(
        ...
        if ("record-is-null".equals(filter)) {
            log.debug("REST request to get all Employees where record is null");
            return new ResponseEntity<>(employeeService.findAllWhereRecordIsNull(), HttpStatus.OK);
        }
