...
class CompanyResourceIT {
    ...
    private static final Status DEFAULT_STATUS = Status.COMPLIANT;
    private static final Status UPDATED_STATUS = Status.NON_COMPLIANT;

    private static final String DEFAULT_PHONE = "8";
    private static final String UPDATED_PHONE = "4935";
    ...
    void createCompany() throws Exception {
        ...
        assertThat(testCompany.getAdressLine1()).isEqualTo(DEFAULT_ADRESS_LINE_1);
    ...
    void putNewCompany() throws Exception {
        ...
        assertThat(testCompany.getAdressLine1()).isEqualTo(UPDATED_ADRESS_LINE_1);
    ...
    void partialUpdateCompanyWithPatch() throws Exception {
        ...
        partialUpdatedCompany.status(UPDATED_STATUS).phone(UPDATED_PHONE).adressLine2(UPDATED_ADRESS_LINE_2).country(UPDATED_COUNTRY);
